...
def checkout(request, username):
    ...
    client.session.trust_env = False  # Disable SSL verification for local development
    ...
    try:
        ...
        return render(request, 'checkout.html', {
            ...
            'error': 'Palyment service is currently unreachable.Please check your internet/proxy settings and try again.',
        })
